---
description: "Run comprehensive checks, process output, and remediate findings"
---

Run the checks orchestrator script with auto-fix enabled, process all output, and automatically remediate findings where possible.
...
- All tests pass
- Coverage >= threshold (configured in checks-config.yaml)
